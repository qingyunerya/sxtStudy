...
public class GameObject3{
	...
	public GameObject3(int x, int y) {
		super();
		this.x = x;
		this.y = y;
	...
	public GameObject3(int x, int y, int width, int height, int speed,int degree) {
		super();
		this.x = x;
		this.y = y;
		this.width = width;
	...
	public GameObject3(Image img,int x, int y) {
		super();
		this.img=img;
		this.x = x;
		this.y = y;
	...
	public GameObject3(Image img,int x, int y, int width, int height, int speed,int degree) {
		super();
		this.img=img;
		this.x = x;
		this.y = y;
	...
	public GameObject3(Image img,int x, int y,int speed,int degree) {
		super();
		this.img=img;
		this.x = x;
		this.y = y;
